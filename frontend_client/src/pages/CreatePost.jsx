    ...
    <section className="max-2-7xl mx-auto">
      ...
      <form className="mt-16 max-2-3xl" onSubmit={handleChange}>
        <div className="flex flex-col gap-5">
          ...
          <div className="relative vg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            {form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
        ...
        <div className="mt-10">
              <p className="mt-2 text-[#666e75] text-[14px]">
                **Once you have created the image you want, you can share it with others in our community.
              </p>
              <button
                type="submit"
